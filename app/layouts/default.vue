...
<template>
    <header>
        <div class="header-content">
            ...
            <button class="menu-toggle" @click="menuOpen = !menuOpen" :aria-expanded="menuOpen" aria-label="Menu">
              <span class="hamburger" :class="{ open: menuOpen }"></span>
            </button>
            <nav class="header-nav" :class="{ open: menuOpen }">
                <NuxtLink to="/loto/admin">Admin</NuxtLink>
                <NuxtLink to="/loto/client">Affichage</NuxtLink>
